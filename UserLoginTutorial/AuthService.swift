...
//  UserLoginTutorial
//
//  Created by Alexander Korchak on 20.03.2023.
//
...
class AuthService {
    ...
    public func registerUser(with userRequest: RegisterUserRequest, completion: @escaping (Bool, Error?) -> ()) {
    ...
    public func signIn(with userRequest: LoginUserRequest, completion: @escaping (Error?) -> ()) {
